    ...
    public partial class ReSeed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { -6, "This is the Cold Soles movie description", new DateTime(2022, 6, 19, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(507), "http://dotnethow.net/images/movies/movie-8.jpeg", 2, "Cold Soles", 39.5, -5, new DateTime(2022, 6, 2, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(506), -1 },
                    { -5, "This is the Scoob movie description", new DateTime(2022, 5, 28, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(503), "http://dotnethow.net/images/movies/movie-7.jpeg", 4, "Scoob", 39.5, -3, new DateTime(2022, 5, 20, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(502), -1 },
                    { -4, "This is the Race movie description", new DateTime(2022, 5, 25, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(499), "http://dotnethow.net/images/movies/movie-6.jpeg", 0, "Race", 39.5, -2, new DateTime(2022, 5, 20, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(497), -1 },
                    { -3, "This is the Ghost movie description", new DateTime(2022, 6, 6, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(495), "http://dotnethow.net/images/movies/movie-4.jpeg", 5, "Ghost", 39.5, -4, new DateTime(2022, 5, 30, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(493), -4 },
                    { -2, "This is the Shawshank Redemption description", new DateTime(2022, 6, 2, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(491), "http://dotnethow.net/images/movies/movie-1.jpeg", 5, "The Shawshank Redemption", 29.5, -1, new DateTime(2022, 5, 30, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(490), -1 },
                    { -1, "This is the Life movie description", new DateTime(2022, 6, 9, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(486), "http://dotnethow.net/images/movies/movie-3.jpeg", 3, "Life", 39.5, -3, new DateTime(2022, 5, 20, 14, 13, 58, 170, DateTimeKind.Local).AddTicks(445), -3 }
                });
