            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Theaters.Any())
                {
                    context.Theaters.AddRange(new List<Theaters>()
                    {
                        ...
                        {
                            Name = "Theater 1",
                            Logo = "http://dotnethow.net/images/Theaterss/Theaters-1.jpeg",
                            Description = "This is the description of the first Theaters"
                        },
                        new Theaters()
                        {
                            Name = "Theater 2",
                            Logo = "http://dotnethow.net/images/Theaterss/Theaters-2.jpeg",
                            Description = "This is the description of the first Theaters"
                        },
                        new Theaters()
                        {
                            Name = "Theater 3",
                            Logo = "http://dotnethow.net/images/Theaterss/Theaters-3.jpeg",
                            Description = "This is the description of the first Theaters"
                        },
                        new Theaters()
                        {
                            Name = "Theater 4",
                            Logo = "http://dotnethow.net/images/Theaterss/Theaters-4.jpeg",
                            Description = "This is the description of the first Theaters"
                        },
                        new Theaters()
                        {
                            Name = "Theater 5",
                            Logo = "http://dotnethow.net/images/Theaterss/Theaters-5.jpeg",
                            Description = "This is the description of the first Theaters"
                        },
                    });
                    context.SaveChanges();
